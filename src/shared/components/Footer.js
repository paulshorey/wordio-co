...
export default () => (
  <StyledFooter>
    <div className="footerCopyright">
      ...
      {/*<p className="content">*/}
      {/*  Get this same <Link href="/docs"><a>data, results, and algorithms</a></Link> for your site |{" "}*/}
      {/*  <Link href="/docs"><a>this API is now available</a></Link> | <Link href="/contact"><a>Contact us</a></Link> | Text analysis{" "}*/}
