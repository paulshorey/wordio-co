      ...
      <>
        ...
        <AboutUs className="content">
          ...
          <div className="before">
            ...
            <p>
              We are still tweaking the thesaurus and domain suggestions engine. Paul is busy improving the algorithms
              and inventing more nifty tools.
            </p>
          </div>
          <div className="after">
            <p>
