...
const USE_CAPTCHA_IN_DEV = false;
const USE_CAPTCHA = USE_CAPTCHA_IN_DEV || PRODUCTION; // use captcha in development?
...
class Search extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
     ...
     */
    // cconsole.info('this.props.router.query',this.props.router.query)
    // cconsole.info('this.props.router.asPath',this.props.router.asPath)
