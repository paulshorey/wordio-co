        ...
        <Search
          ...
          cue={[
            <span key="2" className="">
              Try it ☝️ Use our <Link href="/docs">API</Link> to match 1000s of TLDs to 100000s of{" "}
            ...
            <div className="content">
              ...
              <center>
                <h2 className="attention">
                  Use our AI to increase<span className="hide-small"> your</span> domain sales{" "}
                  <sub className="nowrap">(or to find a great domain)</sub>
                </h2>
                <p>
              ...
              <ul className="article_ul">
                ...
                <li className="article_li">
                  ...
                  <p>
                    ...
                    the surface of NLP (Natural Language Processing), but we already use them to create fun and catchy
                    2-3 word phrases. We are actively expanding our linguistic capabilities.
                  </p>
                </li>
